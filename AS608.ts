...
modified from c
Geändert und erweitert für Calliope mini 21.05.23 M.Klein
*/

//% color=#8C6440 icon="\uf0a6" block="Fingerprint"
namespace Fingerprint {
    ...
    //% block.loc.de="Fingerabdrucksensor an RX %txpin und TX %rxpin"
    //% weight=20 txpin.defl=SerialPin.C17 rxpin.defl=SerialPin.C16
    ...
    //% block.loc.de="Finger suchen"
    //% weight=15
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    export function Fingersearch(): number {
        searchfig()
    ...
    //% block.loc.de="Fingerheben abwarten"
    //% weight=14
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% block.loc.de="Speichere Finger in|ID %value"
    //% weight=10 value.defl=1
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% block.loc.de="Lösche Finger in|ID %value"
    //% weight=5 value.defl=1
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
